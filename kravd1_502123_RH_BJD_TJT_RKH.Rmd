...
#  add_column("period" = cut(x=elorka$ár, breaks = c(1990, 2000, 2011, 2021), dig.lab=4, left=FALSE, include.lowest = TRUE))
#elorka_perioda
elorka_perioda <- elorka %>% 
...
c_sum <- as_tibble(cumsum(p_sum))
c_sum
arrange(c_sum, desc(value))
```
