...
```{r}
# har eru 192 observatiónir við 3 variablum. Hetta gevur tilsamans 576 observatiónir.
# Tað rætta svarið er nokk 192 og 3 !!
#length(as.matrix(akfar))
```
```{r}
count(akfar)
```
```{r}
variable.names(akfar)
```
